...
public:
    ...
    Event_Service(Event_Repo& event_repo, Event_Validation event_validator) : event_repo{ std::move(event_repo) }, event_validator{ event_validator } {}
