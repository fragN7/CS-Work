...
void Event_Validation::validate_link(std::string link) {
...
void Event_Validation::validate_event(std::string link, const std::string& description, const std::string& title, const std::string& date_time) {
