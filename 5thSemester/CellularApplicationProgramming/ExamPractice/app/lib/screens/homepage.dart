...
import 'package:fitness_tracker/screens/progress_section.dart';
import 'package:fitness_tracker/screens/team_member_section.dart';
import 'package:fitness_tracker/widgets/notification.dart';
            ...
            ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const ProgressSection()));
                },
            ...
            ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const TeamMemberSection()));
                },
                child: const Text('Team Member Section')),
