from src.errors.exceptions import RepoError, ValidationError, UndoError
...
class UserInterface:
    ...
    def __init__(self, service_student, service_assignment, service_grade, service_population, undo_redo):
        self.__service_student = service_student
        self.__service_assignment = service_assignment
        self.__service_grade = service_grade
        self.__service_population = service_population
    ...
    def run_ui(self):
        self.__service_population.populate_list()
